 ...
 */
package com.opidis.ca.generated.information_schema.routines;
...
public class _PgTruetypid extends AbstractRoutine<Long> {
    ...
    private static final long serialVersionUID = 840959131;
     ...
     */
    public static final Parameter<PgAttributeRecord> _1 = createParameter("_1", com.opidis.ca.generated.pg_catalog.tables.PgAttribute.PG_ATTRIBUTE.getDataType(), false, true);

    /**
     * The parameter <code>information_schema._pg_truetypid._2</code>.
     */
    public static final Parameter<PgTypeRecord> _2 = createParameter("_2", com.opidis.ca.generated.pg_catalog.tables.PgType.PG_TYPE.getDataType(), false, true);
